...
public class CardV3 {
    ...
    */
   public CardV3(String cardRank, String cardSuit, int cardPointValue)
   {
      rank = cardRank;
      suit = cardSuit;
    ...
    *         false otherwise.
    */
   public boolean matches(CardV3 otherCard)
   {
   ...
   {
      return String.format("%-5s %-5s %-5s %-10s %-10d",rank, "of", suit, "point value = ",pointValue);
   }
}